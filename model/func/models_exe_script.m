function models_exe_script(imod, mode_lapse, path_dir)
...
bads_folder_path = strcat([path_dir, '/model/out/'], mod_str ) ;
...
%%%%%%% until here, we ran bads optimization -|


dataset = matT; 
main_trainer(dataset, imod, mod_str, expInfo, bads_folder_path, mode_lapse)
