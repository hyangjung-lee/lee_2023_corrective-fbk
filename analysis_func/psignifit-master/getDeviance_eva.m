function [devianceResiduals,deviance,samples_deviance,samples_devianceResiduals] = getDeviance_eva(result, pred_null,Nsamples)
...
if (pred_null == 1)
    pPred = 0.5*ones( length(result.data(:,1)) , 1);
else
