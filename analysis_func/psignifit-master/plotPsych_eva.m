function [plot_results ] = plotPsych_eva(result,plotOptions)
...
if result.options.logspace
    ...
    x         = linspace(min(result.data(:,1)),max(result.data(:,1)),2000);
...
plot_results.fineTimes = x;

plot_results.curveYfit = fitValues;
